...
export const LOCATIONS = [
  {
    ...
    lat: 29.4988,
    lng: -98.7081,
    tags: ['Uber Eats', 'DoorDash', 'Pickup'],
    note: 'Uno de los puntos mas fuertes para pedidos al oeste.',
    orderUrl: 'https://www.clover.com/online-ordering/al-carbon-4-san-antonio',
  ...
  },
  {
    ...
    lat: 29.4499,
    lng: -98.5338,
    tags: ['Drive Thru', 'Uber Eats', 'DoorDash'],
    note: 'La sucursal con drive thru para salir rapido.',
    orderUrl: 'https://www.clover.com/online-ordering/al-carbon-1-san-antonio',
  ...
  },
  {
    ...
    lat: 29.4502,
    lng: -98.5365,
    tags: ['Call In Orders', 'Pickup'],
    note: 'Ideal para pedidos por telefono y pickup directo.',
    orderUrl: 'https://www.clover.com/online-ordering/al-carbon-2-san-antonio',
  ...
  },
  {
    ...
    lng: -98.4072,
    tags: ['Uber Eats', 'DoorDash', 'Pickup'],
    note: 'Cobertura comoda para pickup y delivery.',
    orderUrl: 'https://www.clover.com/online-ordering/al-carbon-3-san-antonio',
  ...
  },
  {
    ...
    lng: -98.6344,
    tags: ['Uber Eats', 'DoorDash', 'Pickup'],
    note: 'Nuevo punto para pedidos al oeste y zona Marbach.',
    orderUrl: 'https://www.clover.com/online-ordering/al-carbon-5-san-antonio',
