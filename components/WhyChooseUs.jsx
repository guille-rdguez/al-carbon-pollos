...
import premiumFoodImage from '../assets/Ultra_realistic_cinematic_food_commercial_202605122015.jpeg';
...
const VALUES = [
  ...
  },
  {
    ...
    desc: 'Pickup, drive thru en Culebra 1 y delivery en apps para resolver la comida sin sacrificar sabor.',
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <figure className="relative min-h-[420px] overflow-hidden rounded-[15px] border border-white/10 bg-white/5 shadow-[0_24px_70px_rgba(0,0,0,0.32)]">
            <img
              src={premiumFoodImage}
              alt="Pollo al carbon en caja premium con brasa y humo"
          ...
          <div className="grid content-between gap-5 border-y border-white/10 py-6 lg:border-y-0 lg:border-l lg:py-0 lg:pl-7">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.32em] text-primary">Mesa norteña</p>
              <h3 className="mt-3 font-display text-5xl uppercase leading-[0.86] tracking-[0.03em] text-white">
                Hecho para ordenar rapido y comer en serio.
              </h3>
              <p className="mt-5 text-sm leading-7 text-white/50">
                Cada orden mantiene el mismo ritmo: fuego alto, porciones generosas y una carta que se entiende desde el primer antojo.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-x-6 gap-y-5 border-t border-white/10 pt-6">
              <div>
                <p className="font-display text-4xl uppercase text-primary">8</p>
                <p className="mt-1 text-sm text-white/50">piezas en el Whole Chicken</p>
              </div>
              <div>
                <p className="font-display text-4xl uppercase text-primary">16</p>
                <p className="mt-1 text-sm text-white/50">tortillas en la parrillada familiar</p>
              </div>
              <div>
                <p className="font-display text-4xl uppercase text-primary">5</p>
                <p className="mt-1 text-sm text-white/50">sucursales activas</p>
              </div>
              <div>
                <p className="font-display text-4xl uppercase text-primary">2</p>
                <p className="mt-1 text-sm text-white/50">salsas para rematar</p>
              </div>
            </div>
          </div>
        </div>
